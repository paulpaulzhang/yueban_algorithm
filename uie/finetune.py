    ...
    for epoch in epoch_iterator:
        ...
        for batch in train_data_iterator:
            ...
            if args.device == 'mps':
                ...
                token_type_ids = token_type_ids.to("mps")
                att_mask = att_mask.to("mps")
                start_ids = start_ids.to("mps")
                end_ids = end_ids.to("mps")
        ...
        if args.early_stopping:
            ...
            if early_stopping.early_stop:
                if show_bar:
                    ...
                    logger.info("Early stopping")
                tokenizer.save_pretrained(early_stopping_save_dir, legacy_format=True)
                sys.exit(0)
